...
## above is correct solution w/o labels
...
# })
#works well to go straight to DataFrame
...
#durations_df.rows=['Year','Avg Minutes']
...
#plt.plot(durations_df.years, durations_df.minutes)
#plt.plot(durations_df.x, durations_df.0)
